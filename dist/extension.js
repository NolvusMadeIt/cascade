...
</body></html>`}update(e){this.render(e)}};function J(o){for(let e of q)e.update(o)}function be(o){let e=new $(o),t=new $(o),s=new $(o);o.subscriptions.push(i.window.registerWebviewViewProvider("cascade.chat",e,{webviewOptions:{retainContextWhenHidden:!0}}),i.window.registerWebviewViewProvider("cascade.panel",t,{webviewOptions:{retainContextWhenHidden:!0}}),i.window.registerWebviewViewProvider("cascade.secondary",s,{webviewOptions:{retainContextWhenHidden:!0}}),i.window.registerWebviewViewProvider("cascade.tasks",new V,{webviewOptions:{retainContextWhenHidden:!0}}),i.commands.registerCommand("cascade.newChat",()=>e.newChat()),i.commands.registerCommand("cascade.openSettings",()=>e.openSettingsCmd()),i.commands.registerCommand("cascade.clearHistory",()=>e.clearHistory()),i.commands.registerCommand("cascade.focusSidebar",()=>i.commands.executeCommand("cascade.chat.focus")),i.commands.registerCommand("cascade.focusPanel",()=>i.commands.executeCommand("cascade.panel.focus")),i.commands.registerCommand("cascade.focusSecondary",()=>i.commands.executeCommand("cascade.secondary.focus")),i.commands.registerCommand("cascade.showTasks",()=>i.commands.executeCommand("cascade.tasks.focus"))),setTimeout(()=>{ge(o),fe(o)},3e3)}function we(){}var $=class{constructor(e){this.ctx=e;this.attachments=[];this.pendingFiles=new Map;this.sessions=new W(e.globalState)}resolveWebviewView(e){this.view=e,e.webview.options={enableScripts:!0,localResourceRoots:[this.ctx.extensionUri]},e.webview.html=this.getHtml(e.webview),e.webview.onDidReceiveMessage(t=>this.onMessage(t)),e.onDidChangeVisibility(()=>{e.visible&&this.pushSessionState()})}getHtml(e){let t=X(),s=e.asWebviewUri(i.Uri.joinPath(this.ctx.extensionUri,"dist","chat.js")),a=e.asWebviewUri(i.Uri.joinPath(this.ctx.extensionUri,"media","chat.css")),n=e.asWebviewUri(i.Uri.joinPath(this.ctx.extensionUri,"media","cascade-icon.svg")),u=e.asWebviewUri(i.Uri.joinPath(this.ctx.extensionUri,"media","cascade-logo.svg")),l=c("provider","openrouter"),w=c("model",N[l]);return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
...
Then end with a brief confirmation sentence. That is your entire response.`];f&&D.push(f);let C=e;this.attachments.length&&(C=`${this.attachments.map(y=>`<attachment name="${y.label}">
${y.content}
</attachment>`).join(`
`)}
